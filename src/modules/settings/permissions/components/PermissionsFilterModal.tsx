...
type PermissionsFilterModalProps = {
  isOpen: boolean;
  filter: Pick<PermissionsListDto, 'startDate' | 'endDate'>;
  onClose: () => void;
  onApply: (startDate: string, endDate: string) => void;
  onReset: () => void;
};

export const PermissionsFilterModal: React.FC<PermissionsFilterModalProps> = ({
  isOpen,
  filter,
  onClose,
  onApply,
